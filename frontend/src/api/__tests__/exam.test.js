...
describe('examApi', () => {
  ...
  it('uses the PracticeSession exam contract', async () => {
    ...
    await examApi.saveRecoverySnapshot('session-1', { current_question_id: 'question-1' })
    ...
    expect(api.put).toHaveBeenCalledWith('/exams/sessions/session-1/recovery-snapshot', { current_question_id: 'question-1' })
