...
class CreateVariantSessionRequest(BaseModel):
    idempotency_key: str = Field(min_length=8, max_length=128)
    variation_dimension: str | None = Field(default=None, min_length=1, max_length=40)
...
async def create_error_variant_session(
    ...
    """Create one owner-bound, deterministically verified draft variant session."""
